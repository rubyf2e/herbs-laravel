<template>
	<div class="tree" id="treeBox">
		...
		<svg version="1.1"  v-show="show"  id="treeId" class="treeObject" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		<g>
			...
			C313.692,189.764,311.886,190.086,310.002,190.086z" transform="scale(0, 0)"/>
			<path class="apple" style="fill:#E03A32;" d="M243.442,117.382c-9.316,0-16.896-7.58-16.896-16.896c0-1.883,0.324-3.69,0.895-5.383
			c-6.682,2.255-11.512,8.569-11.512,16.001c0,9.316,7.58,16.896,16.896,16.896c7.432,0,13.746-4.831,16.001-11.512
			C247.132,117.06,245.326,117.382,243.442,117.382z" transform="scale(0, 0)"/>
			...
			C170.043,202.305,169.376,202.374,168.69,202.374z" transform="scale(0, 0)"/>
		</g>
...
export default {
	...
	watch: {
		...
		now: function (value) {
			this.show = (value >= this.getElementTop(document.getElementById('treeBox'))-700) ? true :false;
		}
	},
	mounted() {
	...
	methods: {
		play(){
			...
			setTimeout(() => {
				self.runType  = -1;
				self.runNum   = self.runRangeUp;
				self.runStyle = 'scale(0, 0)';
		...
		runTarget(target){
			var apple     = document.querySelectorAll(target);
			var isChrome  = navigator.userAgent.match("Chrome"); 
			if(isChrome){
				for (var i = 0; i < apple.length; i++) {
					apple[i].setAttribute('transform-origin', '40% 20%');
